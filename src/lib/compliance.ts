  ...
  return [
    {
      rule: "hero-present",
      passed: heroPresent,
      detail: heroPresent ? undefined : "Hero image is missing",
    },
    {
      rule: "logo-present",
      passed: logoPresent,
      detail: logoPresent ? undefined : "Logo is missing",
    },
    {
      rule: "packshot-present",
      passed: packshotPresent,
      detail: packshotPresent ? undefined : "Packshot is missing",
    },
  ];
}
